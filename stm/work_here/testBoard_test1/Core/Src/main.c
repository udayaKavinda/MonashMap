...
/* USER CODE BEGIN PV */
uint8_t tx_buffer[27]="Welcome to Binary\n\r";
/* USER CODE END PV */
...
int main(void)
{
  ...
  while (1)
  {
//	  HAL_GPIO_TogglePin(SEN_EN1_GPIO_Port,SEN_EN1_Pin);
//	  HAL_Delay(1000);
    /* USER CODE END WHILE */
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, SPI_SEL2_Pin|SPI_SEL1_Pin|SPI_SEL0_Pin|SEN_EN4_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, SEN_EN1_Pin|SEN_EN3_Pin|SEN_EN2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : SPI_SEL2_Pin SPI_SEL1_Pin SPI_SEL0_Pin SEN_EN4_Pin */
  GPIO_InitStruct.Pin = SPI_SEL2_Pin|SPI_SEL1_Pin|SPI_SEL0_Pin|SEN_EN4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
